...
import consultasSql.control_estudiantes;
/**
 * 
 * @author bfaq
 * Interfaz estudiantes para registro de los mismos.
 */
...
public void limpiar()
   ...
   this.dispose();
    ...
    String carnet,nom,ape,doc,sex,tipo; 
        ...
        {
         if( doc.length() >= 3 && doc.length() <=15 && nom.length() >= 3 && nom.length() <=20 && carnet.length() >= 3 && carnet.length() <=12
        		 && ape.length() >= 3 && ape.length() <= 45){
        	 ...
        	 JOptionPane.showMessageDialog(null, "Longitud de los caracteres debe ser: \n -Nombre: 3 a 20\n -Apellido: 3 a 45 \n -Carnet: 3 a 12 \n -Documento: 3 a 10", "Error",JOptionPane.WARNING_MESSAGE);
         } 
    ...
    private void jButton_nuevoregActionPerformed(java.awt.event.ActionEvent evt) {
    desbloquear();
    jTextField_carnet.requestFocus();
    }

    private void jTextField_carnetActionPerformed(java.awt.event.ActionEvent evt) {
    jTextField_carnet.transferFocus();        
    }

    private void jTextField_documentoActionPerformed(java.awt.event.ActionEvent evt) {
    jTextField_documento.transferFocus();       
    }

    private void jComboBox_tipodocActionPerformed(java.awt.event.ActionEvent evt) {
    jComboBox_tipodoc.transferFocus();       
    }

    private void jTextField_nombresActionPerformed(java.awt.event.ActionEvent evt) {
    jTextField_nombres.transferFocus();        
    }

    private void jTextField_apellidosActionPerformed(java.awt.event.ActionEvent evt) {
    jTextField_apellidos.transferFocus();        
    }

    private void jComboBox_sexoActionPerformed(java.awt.event.ActionEvent evt) {
    jComboBox_sexo.transferFocus();        
    }
